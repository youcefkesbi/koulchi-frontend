...
### Essential Guides
- **[OAuth Environment Setup](OAUTH_ENVIRONMENT_SETUP.md)** - Complete environment configuration
...
### 1. Environment Setup
- **Development**: Create `.env.local` with development configuration
- **Production**: Configure Vercel environment variables with production configuration
...
- Automatic environment-specific OAuth configuration
- Fixed callback path (`/auth/v1/callback`) for consistency
...
- `docs/env.local.example` - Development environment template
- `docs/env.production.example` - Production environment template
- `docs/OAUTH_ENVIRONMENT_SETUP.md` - Complete environment setup guide
- `docs/OAUTH_ENVIRONMENT_QUICK_REFERENCE.md` - Quick environment setup reference
