  ...
  <div class="space-y-20 animate-fade-in px-4">
    ...
    <section id="new-products" class="animate-slide-up">
      <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-bold text-dark">{{ $i18n.t('sections.newProducts') }}</h2>
        <router-link to="/products" class="text-primary hover:text-primary-dark text-base font-semibold hover:underline transition-colors">
          {{ $i18n.t('sections.viewAll') }} <i class="fas fa-arrow-left mr-2"></i>
        </router-link>
      </div>
    ...
    <section class="animate-slide-up">
      <h2 class="text-3xl font-bold text-dark mb-8 text-center">{{ $i18n.t('sections.browseByCategory') }}</h2>
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-slide-up">
      <div class="card text-center group hover:shadow-glow transform hover:scale-105 transition-all duration-300">
        ...
        <h3 class="text-xl font-bold mb-3 text-dark">{{ $i18n.t('features.fastDelivery') }}</h3>
        <p class="text-gray-600 leading-relaxed text-sm">{{ $i18n.t('features.fastDeliveryDesc') }}</p>
      </div>
      ...
      <div class="card text-center group hover:shadow-glow transform hover:scale-105 transition-all duration-300">
        ...
        <h3 class="text-xl font-bold mb-3 text-dark">{{ $i18n.t('features.cod') }}</h3>
        <p class="text-gray-600 leading-relaxed text-sm">{{ $i18n.t('features.codDesc') }}</p>
      </div>
      ...
      <div class="card text-center group hover:shadow-glow transform hover:scale-105 transition-all duration-300">
        ...
        <h3 class="text-xl font-bold mb-3 text-dark">{{ $i18n.t('features.qualityGuarantee') }}</h3>
        <p class="text-gray-600 leading-relaxed text-sm">{{ $i18n.t('features.qualityGuaranteeDesc') }}</p>
      </div>
    </section>

    <!-- Why Choose Us Section -->
    <section class="bg-gradient-to-br from-light-gray to-white rounded-3xl p-12 shadow-soft animate-slide-up">
      <h2 class="text-4xl font-bold text-dark mb-12 text-center">{{ $i18n.t('sections.whyChooseUs') }}</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div class="space-y-6">
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="font-bold text-xl text-dark mb-2">{{ $i18n.t('benefits.securePayment') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.securePaymentDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="text-xl font-bold mb-2 text-dark">{{ $i18n.t('benefits.fastDeliveryAlgeria') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.fastDeliveryAlgeriaDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="text-xl font-bold mb-2 text-dark">{{ $i18n.t('benefits.originalProducts') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.originalProductsDesc') }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="text-xl font-bold mb-2 text-dark">{{ $i18n.t('benefits.competitivePrices') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.competitivePricesDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="text-xl font-bold mb-2 text-dark">{{ $i18n.t('benefits.customerService') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.customerServiceDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4 space-x-reverse group">
            ...
            <div>
              <h4 class="text-xl font-bold mb-2 text-dark">{{ $i18n.t('benefits.easyOrdering') }}</h4>
              <p class="text-gray-600 leading-relaxed">{{ $i18n.t('benefits.easyOrderingDesc') }}</p>
            </div>
          </div>
        </div>
      </div>
