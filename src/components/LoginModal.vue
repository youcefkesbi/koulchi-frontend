...
<div>
  <form v-if="isSignup" @submit.prevent="handleSignup">
    <div class="mb-3">
      ...
      <input v-model="signupForm.username" type="text" required class="w-full px-3 py-2 border rounded" />
    </div>
    <div class="mb-3">
      <label class="block mb-1 text-sm font-medium text-gray-700">{{ $t('email') }}</label>
      <input v-model="signupForm.email" type="email" required class="w-full px-3 py-2 border rounded" />
    </div>
    <div class="mb-3">
      <label class="block mb-1 text-sm font-medium text-gray-700">{{ $t('password') }}</label>
      <input v-model="signupForm.password" type="password" required class="w-full px-3 py-2 border rounded" />
    </div>
    <div class="mb-3">
      <label class="block mb-1 text-sm font-medium text-gray-700">{{ $t('confirmPassword') }}</label>
      <input v-model="signupForm.confirmPassword" type="password" required class="w-full px-3 py-2 border rounded" />
    </div>
